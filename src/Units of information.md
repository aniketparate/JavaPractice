...
## Conclusion
To wrap-up:
1. The smallest unit of information is a bit.
1. One byte consists of 8 bits.
1. For convenience in computer science, we use binary-base units of information as bytes, kibibytes, mebibytes, etc.
1. To convert one kibibyte to bytes, we need to multiply one to 2102 ^ {10}210, to convert one mebibyte, to multiply one to 2202 ^ {20}220, etc.
